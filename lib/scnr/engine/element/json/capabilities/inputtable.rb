...
# Extends {Engine::Element::Capabilities::Inputtable} with {JSON}-specific
# functionality.
#
...
module Inputtable
    ...
    # Overrides {Engine::Element::Capabilities::Inputtable#inputs=} to allow
    # for non-string data of variable depth.
    #
    # @param    (see SCNR::Engine::Element::Capabilities::Inputtable#inputs=)
    # @return   (see SCNR::Engine::Element::Capabilities::Inputtable#inputs=)
    # @raise    (see Engine::Element::Capabilities::Inputtable#inputs=)
    #
    # @see  Engine::Element::Capabilities::Inputtable#inputs=
    def inputs=( h )
    ...
    # @return   [Object]
    #
    # @see  Engine::Element::Capabilities::Inputtable#[]
    def []( name )
        key, data = find( name )
        data[key]
    end
    ...
    # of variable depth.
    #
    # @param    (see SCNR::Engine::Element::Capabilities::Inputtable#update)
    # @return   (see SCNR::Engine::Element::Capabilities::Inputtable#update)
    # @raise    (see Engine::Element::Capabilities::Inputtable#update)
    #
    # @see  Engine::Element::Capabilities::Inputtable#update
    def update( hash )
