...
# {SCNR::Engine::Element::Capabilities::Mutable} elements.
#
...
module Auditable
    ...
    def Auditable.calculate_cost( payloads_size, options = {} )
    ...
    #       {WithPlatforms#platforms applicable platforms} for the
    #       {Submittable#action resource} to be audited.
    # @param  [Hash]    opts
    ...
    #   * `false` when:
    #       * There are no {Inputtable#inputs} inputs.
    ...
    #   its name, {Element::Base#type} and {Submittable#action}.
    ...
    def audit_single( payload, opts = { }, &block )
        ...
        each_mutation_proc = @audit_options.delete(:each_mutation)
        ...
        each_mutation( payload, @audit_options ) do |elem|
            ...
            exception_jail false do
                ...
                if each_mutation_proc && (elements = each_mutation_proc.call( elem ))
