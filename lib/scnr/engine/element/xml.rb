...
class XML < Base
    ...
    def initialize( options )
        ...
        fail SCNR::Engine::Element::Capabilities::WithSource::Error::MissingSource if !@source
    ...
    def to_xml
        doc = SCNR::Engine::Parser.parse_xml( source ).dup
    ...
    class <<self
        ...
        def parse_inputs( doc )
            doc = doc.is_a?( Nokogiri::XML ) ? doc : SCNR::Engine::Parser.parse_xml( doc )
...
SCNR::Engine::XML = SCNR::Engine::Element::XML
