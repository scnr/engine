...
class Scope < SCNR::Engine::OptionGroup
    ...
    # @note `nil` is infinite -- default is `4`.
    #
    # @return    [Integer]
    ...
    # @note `nil` is infinite -- default is `500`.
    #
    # @return    [Integer]
    ...
    #
    # @see URICommon::Scope#redundant?
    # @see URICommon::Scope#auto_redundant?
    ...
    #
    # @see URICommon::Scope#exclude_file_extension?
    ...
    #   a insecure link.
    #
    # @see URICommon::Scope#follow_protocol?
