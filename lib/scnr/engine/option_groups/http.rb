...
# Holds {SCNR::Engine::HTTP} related options.
#
# @author Tasos "Zapotek" Laskos <tasos.laskos@gmail.com>
class HTTP < SCNR::Engine::OptionGroup
    ...
    # @return   [Integer]
    #   Maximum HTTP {SCNR::Engine::HTTP::Response response} body size. If a
    #   {SCNR::Engine::HTTP::Response#body} is larger than specified it will not be retrieved.
    #
    # @see HTTP::Response
