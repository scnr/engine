...
module Utilities
    ...
    def full_and_absolute_url?( url )
        SCNR::Engine::URI.full_and_absolute?( url.to_s )
    end
    ...
    # * {#path_in_domain?}
    #
    # @param    [SCNR::Engine::URI, ::URI, Hash, String] path
    #
    # @return   [Bool]
    def skip_path?( path )
        return true if !path
    ...
    # Determines whether or not the given {Engine::HTTP::Response} should be
    # ignored.
    #
    ...
    # Determines whether or not the given {Engine::Page}.
    #
    # @param    [Page]   page
    #
    # @return   [Bool]
    ...
    #
    # @param    [Page,SCNR::Engine::HTTP::Response,String]    resource
    #   If given a:
    #
    #       * {Page}: both its URL and body will be examined.
    #       * {Engine::HTTP::Response}: both its effective URL and body will be examined.
