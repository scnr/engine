...
class ElementLocator
    ...
    def css
        ...
        elsif attributes[ENGINE_ID]
            attrs[ENGINE_ID] = attributes[ENGINE_ID]
        ...
        "#{tag_name}#{attrs.sort_by{ |k, _| k }.
          map { |k, v| "[#{k}=\"#{v.escape_double_quote}\"]"}.join}"
    end
