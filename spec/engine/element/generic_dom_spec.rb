...
describe SCNR::Engine::Element::GenericDOM do
    ...
    let(:transition) do
        SCNR::Engine::Page::DOM::Transition.new( element, :keypress, transition_options )
    end
    subject do
    ...
    describe '#initialize' do
        it "sets #source form the #{SCNR::Engine::Browser::ElementLocator}" do
