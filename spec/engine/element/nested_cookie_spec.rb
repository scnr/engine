...
describe SCNR::Engine::Element::NestedCookie do
    ...
    it 'should be assigned to SCNR::Engine::NestedCookie for easy access' do
        expect(SCNR::Engine::NestedCookie).to eq(described_class)
    end
