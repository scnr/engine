...
describe SCNR::Engine::State do

    subject { described_class }
    let(:dump_directory) do
        "#{Dir.tmpdir}/state-#{SCNR::Engine::Utilities.generate_token}"
    end
    ...
    describe '#trainer' do
        it "returns an instance of #{described_class::Trainer}" do
            expect(subject.trainer).to be_kind_of described_class::Trainer
        end
    end
