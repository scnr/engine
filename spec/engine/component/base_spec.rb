...
class Subject < SCNR::Engine::Component::Base
...
describe SCNR::Engine::Component::Base do
    subject { Subject }
    let(:info) { Subject.info }

    it "includes #{SCNR::Engine::Component::Output}" do
        expect(subject).to include SCNR::Engine::Component::Output
    end

    it "includes #{SCNR::Engine::Component::Utilities}" do
        expect(subject).to include SCNR::Engine::Component::Utilities
    end
