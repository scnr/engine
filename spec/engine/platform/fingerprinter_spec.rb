...
describe SCNR::Engine::Platform::Fingerprinter do

    describe '#page' do
        it 'returns the given page' do
            page = SCNR::Engine::Page.new( url: 'http://test/' )
    ...
    describe '#parameters' do
        it 'returns the downcased page parameters' do
            page = SCNR::Engine::Page.new( url: 'http://stuff.com/?A=B&C=D' )
    ...
    describe '#extension' do
        it 'returns the file extension of the page resource' do
            page = SCNR::Engine::Page.from_data( url: 'http://stuff.com/blah.stuff/page.pHp' )
