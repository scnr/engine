...
describe SCNR::Engine::Plugin::Manager do
    ...
    describe '#suspend' do
        ...
        let(:state) { SCNR::Engine::State.plugins.runtime }
    ...
    describe '#restore' do
        ...
        context 'when a loaded plugin has no associated state' do
            it "calls #{SCNR::Engine::Plugin::Base}#prepare instead of #{SCNR::Engine::Plugin::Base}#restore" do
    ...
    describe '#results' do
        it "delegates to ##{SCNR::Engine::Data::Plugins}#results" do
            expect(SCNR::Engine::Data.plugins.results.object_id).to eq(
