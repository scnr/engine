...
# require 'json'
#
# describe 'Engine::RPC::Server::Framework' do
#     before( :all ) do
...
#             expect(@framework_clean.version).to eq(SCNR::Engine::VERSION)
#         end
#     end
...
#             expect(@framework_clean.list_platforms).to eq(SCNR::Engine::Framework.new.list_platforms)
#         end
#     end
#
#     describe '#run' do
...
#             expect(report.is_a?( SCNR::Engine::Report )).to be_truthy
...
#                 expect(data).to include :messages
...
#
#             issue = issues.first
#             expect(issue.is_a?( SCNR::Engine::Issue )).to be_truthy
#         end
#     end
#
