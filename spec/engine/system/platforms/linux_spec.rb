...
describe SCNR::Engine::System::Platforms::Linux do
    it_should_behave_like 'SCNR::Engine::System::Platforms::Mixins::Unix'
    ...
    describe '.current?' do
        context 'when running on Linux' do
            it 'returns true' do
                expect(SCNR::Engine).to receive(:linux?).and_return( true )
        ...
        context 'when not running on Linux' do
            it 'returns false' do
                expect(SCNR::Engine).to receive(:linux?).and_return( false )
