...
describe SCNR::Engine::ElementFilter do
    ...
    describe '#forms' do
        it "keeps track of forms by #{SCNR::Engine::Element::Form}#id" do
    ...
    describe '#links' do
        it "keeps track of links by #{SCNR::Engine::Element::Link}#id" do
    ...
    describe '#cookies' do
        it "keeps track of cookies by #{SCNR::Engine::Element::Link}#id" do
