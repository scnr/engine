...
describe SCNR::Engine::Data::Framework do
    ...
    describe '#page_queue' do
        it "returns an instance of #{SCNR::Engine::Support::Database::Queue}" do
            expect(subject.page_queue).to be_kind_of SCNR::Engine::Support::Database::Queue
        end
    end
    ...
    describe '#url_queue' do
        it "returns an instance of #{SCNR::Engine::Support::Database::Queue}" do
            expect(subject.url_queue).to be_kind_of SCNR::Engine::Support::Database::Queue
        end
    end
