...
describe SCNR::Engine::Data::Issues do
    ...
    let(:issue_low_severity) do
        ...
        low.severity = SCNR::Engine::Issue::Severity::LOW
        low
    end
    ...
    let(:issue_medium_severity) do
        ...
        medium.severity = SCNR::Engine::Issue::Severity::MEDIUM
        medium
    end
    ...
    let(:issue_informational_severity) do
        ...
        informational.severity = SCNR::Engine::Issue::Severity::INFORMATIONAL
        informational
    end
    ...
    let(:issue_high_severity) do
        ...
        high.severity = SCNR::Engine::Issue::Severity::HIGH
        high
    end
    ...
    let(:dump_directory) do
        "#{Dir.tmpdir}/issues-#{SCNR::Engine::Utilities.generate_token}"
    end
