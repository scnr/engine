...
describe SCNR::Engine::Issue do
    ...
    it "supports #{SCNR::Engine::RPC::Serializer}" do
        duped = SCNR::Engine::RPC::Serializer.deep_clone( issue )
    ...
    it 'is comparable' do
        informational = issue.dup.tap { |i| i.severity = SCNR::Engine::Issue::Severity::INFORMATIONAL }
        low           = issue.dup.tap { |i| i.severity = SCNR::Engine::Issue::Severity::LOW }
        medium        = issue.dup.tap { |i| i.severity = SCNR::Engine::Issue::Severity::MEDIUM }
        high          = issue.dup.tap { |i| i.severity = SCNR::Engine::Issue::Severity::HIGH }
    ...
    describe '.from_rpc_data' do
        ...
        let(:data) { SCNR::Engine::RPC::Serializer.rpc_data( issue ) }
