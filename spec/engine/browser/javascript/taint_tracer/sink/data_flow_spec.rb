...
describe SCNR::Engine::Browser::Javascript::TaintTracer::Sink::DataFlow do
    ...
    describe '#tainted_argument_name' do
        ...
        context "when there are are no #{SCNR::Engine::Browser::Javascript::TaintTracer::Frame::CalledFunction}#signature_arguments" do
            it 'returns nil' do
