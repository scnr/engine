...
describe SCNR::Engine::Page::DOM::Transition do
        ...
        context 'when the element is a' do
            context 'Symbol' do
                it 'restores it' do
                    ...
                    data     = SCNR::Engine::RPC::Serializer.rpc_data( original )
            ...
            context 'Engine::Browser::ElementLocator' do
                it 'restores it' do
    ...
    describe '#play' do
        let(:url) do
            SCNR::Engine::Utilities.normalize_url( web_server_url_for( :browser ) ) + 'trigger_events'
        end
    ...
    describe '#to_hash' do
        ...
        context "when #element is an #{SCNR::Engine::Browser::ElementLocator}" do
