...
describe SCNR::Engine::HTTP::CookieJar do

    subject { described_class.new }
    let(:cookies) { SCNR::Engine::Utilities.cookies_from_file( '', cookiejar_file ) }
    ...
    describe '.from_file' do
        ...
        context 'when the provided file does not exist' do
            it 'raises Engine::HTTP::CookieJar::Error::CookieJarFileNotFound' do
                trigger = proc { subject.class.from_file( 'file' ) }

                expect { trigger.call }.to raise_error SCNR::Engine::Error
                expect { trigger.call }.to raise_error SCNR::Engine::HTTP::Error
                expect { trigger.call }.to raise_error SCNR::Engine::HTTP::CookieJar::Error
                expect { trigger.call }.to raise_error SCNR::Engine::HTTP::CookieJar::Error::CookieJarFileNotFound
            end
        end
    end
    ...
    describe '#initialize' do
        it 'returns a new instance' do
            expect(SCNR::Engine::HTTP::CookieJar.new.is_a?( SCNR::Engine::HTTP::CookieJar )).to be_truthy
        end
        ...
        context 'when a cookiejer option has been provided' do
            it 'loads cookies from a Netscape cookie-jar file' do
                ...
                cookies = j.cookies
                expect(cookies.size).to eq(4)
                expect(cookies).to eq(SCNR::Engine::Utilities.cookies_from_file( '', cookiejar_file ))
            end
        end

        context 'when the provided file does not exist' do
            it 'raises Engine::HTTP::CookieJar::Error::CookieJarFileNotFound' do
                expect { subject.class.from_file( 'file' ) }.to raise_error SCNR::Engine::HTTP::CookieJar::Error::CookieJarFileNotFound
            end
        end
    end
    ...
    describe '#update' do
        ...
        context 'when passed a' do
            context 'Engine::Cookie' do
                it 'updates the cookie jar with it' do
                    c = SCNR::Engine::Cookie.new( url: 'http://test.com', inputs: { name: 'value' } )
            ...
            context 'String' do
                ...
                context 'when in the form of a Set-Cookie header' do
                    it 'parses it into a Cookie and update the cookie jar with it' do
                        ...
                        SCNR::Engine::Options.url = 'http://test.com'
                        subject.update( 'some_param=9e4ca2cc0f18a49f7c1881f78bebf7df; path=/; expires=Wed, 02-Oct-2040 23:53:46 GMT; HttpOnly' )
    ...
    describe '#for_url' do
        it 'returns all cookies for that particular URL' do
            ...
            cookies[:with_path_0] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'my_cookie',
                value:  'my_value',
                domain: 'domain.com',
            ...
            cookies[:with_path] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'my_cookie',
                value:  'my_value',
                domain: 'domain.com',
            ...
            cookies[:without_path] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'my_cookie1',
                value:  'my_value2',
                domain: 'domain.com',
            ...
            cookies[:another_domain] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'my_cookie1',
                value:  'my_value2',
                domain: 'mydomain.com',
            ...
            cookies[:tailmatching] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'tail_name',
                value:  'tail_value',
                domain: '.mydomain.com',
            ...
            cookies[:subdomain] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'name',
                value:  'value',
            ...
            cookies[:subdomain_tailmatching] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'tail_name',
                value:  'tail_value',
                domain: '.sub.domain.com',
            ...
            cookies[:expired] = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'expired_name',
                value:  'expired_value',
                domain: 'expired.com',
            ...
            expect(subject.for_url( 'http://domain.com/my/path' )).to eq([cookies[:with_path_0], cookies[:without_path]])
    ...
    describe '#for_domain' do
        it 'returns all cookies for the given domain'
    end

    describe '#cookies' do
        before( :each ) do
            subject << SCNR::Engine::Element::Cookie.new(
                url:     '',
                name:    'expired_name',
                value:   'expired_value',
                domain:  'expired.com',
    ...
    describe '#merge!' do
        it 'updates the cookie_jar with the cookies of another' do
            ...
            c = SCNR::Engine::Element::Cookie.new(
                url:    '',
                name:   'my_name',
                value:  'my_value',
                domain: 'domain.com',
