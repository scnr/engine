def browser_pool_job_taint_tracer_execution_flow_check_pages( pages )
...
def browser_pool_job_taint_tracer_data_flow_check_pages( pages )
...
def browser_pool_job_taint_tracer_data_flow_with_injector_check_pages( pages )
    page = pages.find { |page| page.dom.data_flow_sinks.any? }
    expect(page.dom.execution_flow_sinks).to be_empty
