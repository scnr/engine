...
get '/If-None-Match' do
    ...
    <<HTML
<html>
    <img src="/If-None-Match/asset"></img>
...
get '/If-Modified-Since' do
    ...
    <<HTML
<html>
    <img src="/If-Modified-Since/asset"></img>
...
get '/load_delay' do
    ...
    <script>
        setTimeout( function( name, value ){
            document.cookie = name + "=post-1-" + value
        }, 10000, 'timeout1', 1000 );

        setTimeout( function( name, value ){
            document.cookie = name + "=post-2-" + value
        }, 20000, 'timeout2', 2000 );
...
get '/fire_event/form/onsubmit/attribute' do
    <<-EOHTML
<html>
    <script>
        function submitForm() {
...
get '/fire_event/form/onsubmit/listener' do
    <<-EOHTML
<html>
    <script>
        function submitForm() {
        ...
        function submitHandler(){ submitForm(); return false; }
    </script>
