...
describe SCNR::Engine::Platform::Fingerprinters::PHP do
    ...
    context 'when the page has a .php extension' do
        it 'identifies it as PHP' do
            check_platforms SCNR::Engine::Page.from_data( url: 'http://stuff.com/blah.php' )
        end
    end

    context 'when the page has a .php/ rewrite' do
        it 'identifies it as PHP' do
            check_platforms SCNR::Engine::Page.from_data( url: 'http://stuff.com/blah.php/Stuff/1' )
        end
    end

    context 'when the page has a .php5 (or similarly numbered) extension' do
        it 'identifies it as PHP' do
            check_platforms SCNR::Engine::Page.from_data( url: 'http://stuff.com/blah.php5' )
        end
    end
