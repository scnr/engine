...
class SCNR::Engine::Checks::CodeInjection < SCNR::Engine::Check::Base
    ...
    def self.payloads
        ...
        @payloads = {
            ...
            h.merge platform => [ ' %s', ';%s', "\";%s#", "';%s#" ].map { |s| s % payload }
        end
...
Engine was able to inject specific server-side code and have the executed output
