...
class SCNR::Engine::Checks::Rfi < SCNR::Engine::Check::Base # *always* extend SCNR::Engine::Check::Base
...
SCNR::Engine discovered that it was possible to substitute a parameter value with an
