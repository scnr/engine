...
class SCNR::Engine::Checks::SqlInjection < SCNR::Engine::Check::Base

    # payloads which will hopefully cause the webapp to output SQL error messages
    # if included as part of an SQL query.
    PAYLOADS = [ '"\'`--', ')' ]
