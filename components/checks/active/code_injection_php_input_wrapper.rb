...
class SCNR::Engine::Checks::CodeInjectionPhpInputWrapper < SCNR::Engine::Check::Base
...
SCNR::Engine was able to inject specific server-side code via a PHP wrapper (`php://input`)
