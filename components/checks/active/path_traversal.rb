...
class SCNR::Engine::Checks::PathTraversal < SCNR::Engine::Check::Base
...
SCNR::Engine discovered that it was possible to substitute a parameter value with a
