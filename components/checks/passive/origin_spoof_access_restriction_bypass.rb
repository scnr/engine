...
# @version 0.1
class SCNR::Engine::Checks::OriginSpoofAccessRestrictionBypass < SCNR::Engine::Check::Base
...
SCNR::Engine discovered a resource that it did not have permission to access, but been
