...
class SCNR::Engine::Checks::Webdav < SCNR::Engine::Check::Base
...
Engine discovered that the affected page allows WebDAV access. This was discovered
...
component specifically as Engine does support this feature.
},
                references:  {
