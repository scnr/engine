...
class SCNR::Engine::Checks::BackupFiles < SCNR::Engine::Check::Base

    IGNORE_MIME_TYPES = [:image, :video, :audio, :font].inject({}) do |h, k|
        h[k] = SCNR::Engine::OptionGroups::Scope::EXCLUDE_MIME_TYPES[k]
        h
    end
    ...
    def run
        ...
        self.class.formats.each do |format|
            ...
            # the user know how Engine got to the resulting filename.
    ...
    def self.info
        {
            ...
            author:           'Tasos "Zapotek" Laskos <tasos.laskos@gmail.com> ',
            version:          '0.3.3',
            exempt_platforms: SCNR::Engine::Platform::Manager::FRAMEWORKS,
            cost:             formats.size,
...
By utilising the same method, SCNR::Engine was able to discover a possible backup file.
},
                references: {
