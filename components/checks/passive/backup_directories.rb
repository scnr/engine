...
class SCNR::Engine::Checks::BackupDirectories < SCNR::Engine::Check::Base
...
By utilising the same method, SCNR::Engine was able to discover a possible backup directory.
},
                references: {
