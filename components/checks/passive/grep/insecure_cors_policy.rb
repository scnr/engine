...
# @version 0.1.1
class SCNR::Engine::Checks::InsecureCORSPolicy < SCNR::Engine::Check::Base
...
SCNR::Engine detected that the CORS policy being set by the server was weak, and used
...
by using a combination of the wildcard and the domain (example: `*.placeholder.com`).
}
            }
        }
    end
