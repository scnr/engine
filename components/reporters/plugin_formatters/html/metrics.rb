        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <%= Engine::Utilities.bytes_to_megabytes results['general']['egress_traffic'] %>MB
                    </dd>
                    ...
                    <dd>
                        <%= Engine::Utilities.bytes_to_megabytes results['general']['ingress_traffic'] %>MB
                    </dd>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <%= Engine::Utilities.seconds_to_hms results['scan']['duration'] %>
                    </dd>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <%= Engine::Utilities.bytes_to_kilobytes results['http']['response_size_min'] %> KB
                    </dd>
                    <dt>
                        Maximum response size
                    </dt>
                    <dd>
                        <%= Engine::Utilities.bytes_to_kilobytes results['http']['response_size_max'] %> KB
                    </dd>
                    <dt>
                        Average response size
                    </dt>
                    <dd>
                        <%= Engine::Utilities.bytes_to_kilobytes results['http']['response_size_average'] %> KB
                    </dd>
                    ...
                    <dd>
                        <%= Engine::Utilities.bytes_to_kilobytes results['http']['request_size_min'] %> KB
                    </dd>
                    <dt>
                        Maximum request size
                    </dt>
                    <dd>
                        <%= Engine::Utilities.bytes_to_kilobytes results['http']['request_size_max'] %> KB
                    </dd>
                    <dt>
                        Average request size
                    </dt>
                    <dd>
                        <%= Engine::Utilities.bytes_to_kilobytes results['http']['request_size_average'] %> KB
                    </dd>
                </dl>
            ...
            <div class="col-md-9">
                ...
                <dl class="dl-horizontal">
                    <% results['platforms'].each do |type, platforms|
                        ...
                        <dt>
                            <%= Engine::Platform::Manager::TYPES[type.to_sym] %>
                        </dt>
                        <dd>
                            <%= platforms.map { |platform| Engine::Platform::Manager::PLATFORM_NAMES[platform.to_sym] }.join( ', ' ) %>
                        </dd>
                    <% end %>
                </dl>
            </div>
